                ...
                <div className="TitleContainer">
                    <div className="LeftContainer">
                        <div className="ProfileContainer">
                            ...
                            <div className="ProfileName">@MasterChef</div>
                        </div>
                        <div className="Title">Yummy Flapjacks</div>
                    </div>
                    <div className="RightContainer">
                        ...
                        <div className="TimeContainer">
                            ...
                            <div className="Time">25 Minutes</div>
                        </div>
                    </div>
                </div>
                <div className="ContentContainer">
                    <div className="InteractableContainer">
                        <div className="TagContainer">
                            <div className="Tag Yellow">#glutenfree</div>
                            <div className="Tag Blue">#breakfast</div>
                        </div>
                    ...
                    <div className="InfoContainer">
                        ...
                        <div className="DescriptionContainer">
                            Fluffy flapjacks topped with strawberries. Delightful to make and even more so to eat.
                        </div>
                    </div>
                    <div className="InstructionsContainer">
                        <div className="Step">Step 1: Mix dry ingredients into a bowl</div>
                        <div className="Step">Step 2: Adds eggs one at a time to the bowl</div>
                        <div className="Step">Step 3: Cook on griddle for 3 minutes, then flip over and cook 1 minute.</div>
                        <div className="Step">Step 4: Enjoy</div>
                    </div>
                </div>
            </div>
        </div>
